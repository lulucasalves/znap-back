...
exports.postOrdersController =
  exports.postOrdersNewController =
  exports.getMasterOrderController =
  exports.getOrdersController =
    void 0;
...
function getOrdersController(req, res, next) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const masterOrdersRepository = (0, typeorm_1.getRepository)(
      models_1.MasterOrders
    );
    ...
    const master_orders = yield masterOrdersRepository.findAndCount({
      ...
      take: limitInt,
      order: {
        [order !== null && order !== void 0 ? order : "created_at"]:
          sort !== null && sort !== void 0 ? sort : "DESC",
      },
      relations: ["client_id"],
    });
    const masterOrdersData = master_orders[0].map((value) =>
      Object.assign(Object.assign({}, value), { orders: [] })
    );
    const orders = yield ordersRepository.findAndCount({
      where: {
        master_order_id: (0, typeorm_1.In)(
          master_orders[0].map((value) => value.id)
        ),
      },
    ...
    for (const order of orders[0].map((value) =>
      ...
      const otherMasterOrdersData = masterOrdersData.filter(
        (value) => value.id !== order.master_order_id
      );
      ...
      masterOrdersData = [
        ...
        Object.assign(Object.assign({}, masterOrderData), {
          orders: [...masterOrderData.orders, order],
        }),
      ];
    }
    console.log(orders);
...
function getMasterOrderController(req, res, next) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    res.json(
      Object.assign(Object.assign({}, masterOrders), { orders: allOrders })
    );
  });
}
...
function postOrdersNewController(req, res, next) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const result = Object.assign(Object.assign({}, createdMaster), { orders });
    for (const order of orders) {
      const ordersRepository = (0, typeorm_1.getRepository)(models_1.Orders);
      const createOrder = ordersRepository.create(
        Object.assign(Object.assign({}, order), {
      ...
      result = Object.assign(Object.assign({}, result), {
        orders: [createdOrder, ...result.orders],
      });
    }
    res.json(result);
  });
